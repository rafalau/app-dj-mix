...
if errorlevel 1 (
    ...
    echo        Depois rode: gh release upload v1.0.5 dist\DJMixPlayer_Setup_v1.0.5.exe --repo rafalau/app-dj-mix --clobber
    goto :done
)

gh release upload v1.0.5 "dist\DJMixPlayer_Setup_v1.0.5.exe" --repo rafalau/app-dj-mix --clobber
